document.addEventListener("DOMContentLoaded", () => {
  const speakersSlider = document.querySelector(".carousel-container__speakers-slider");
  ...
  const speakerCards = Array.from(document.querySelectorAll(".carousel-container__speaker-card"));
...
document.querySelectorAll(".carousel-container__speaker-card").forEach((card) => {
